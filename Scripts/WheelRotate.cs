...
public class WheelRotate : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Debug.Log(Quaternion.Euler(transform.rotation.eulerAngles.x + wheelAngle, 0, 0));
        transform.rotation = wheelCollider.transform.rotation * Quaternion.Euler(wheelAngle, 0, 0);
